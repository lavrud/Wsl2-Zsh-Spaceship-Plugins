...
Acesse este link para _[Instalar o WSL](https://docs.microsoft.com/pt-br/windows/wsl/install)_, análise os pré-requisitos instale em sua máquina windows <br> e siga o passo-a-passo para executar.
